...
//340
#define RX2_PIN_NUMBER  29  //inside used to com with other chip
#define TX2_PIN_NUMBER  28 //inside used to com with other chip
#define CTS_PIN_NUMBER 7
#define RTS_PIN_NUMBER 5
#define RX_PIN_NUMBER  17  //outside
#define TX_PIN_NUMBER  19 //outside
//#define RX_PIN_NUMBER  19  //outside
//#define TX_PIN_NUMBER  17 //outside
