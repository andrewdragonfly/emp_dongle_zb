...
void zigbee_info (){
  ...
  //  zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_INFO_VALUE_ID, (zb_uint8_t *)&SERIAL, ZB_FALSE);
