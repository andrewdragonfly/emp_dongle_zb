...
DragonFly nRF52840 (BMD-340) HUB

README: If a new configuration is needed that creates a discrepancy between pins, it has to be created 
a new pca10056 header file in components/boards/, change the value in Options -> Preprocessor -> Preprocesor Definitions
to the new pca header file and add a "#elif.." in boards.h
...
#define LED_2          NRF_GPIO_PIN_MAP(0,26)
#define LED_3          NRF_GPIO_PIN_MAP(0,27)*/
#define LED_1          NRF_GPIO_PIN_MAP(1,15) 
#define LED_2          NRF_GPIO_PIN_MAP(0,29)
#define LED_3          NRF_GPIO_PIN_MAP(0,31)
...
//#define BUTTON_1       NRF_GPIO_PIN_MAP(1,14) 
...
//340
#define RX_PIN_NUMBER  23//20//29  
#define TX_PIN_NUMBER  20//23//28 
...
#define RX2_PIN_NUMBER  19  
#define TX2_PIN_NUMBER  17

#define HWFC           true

//Enables ETH
#define ETH_EN NRF_GPIO_PIN_MAP(0,8)

//Enables CAN
#define CAN_EN NRF_GPIO_PIN_MAP(1,9)
