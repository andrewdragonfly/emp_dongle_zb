 ...
 */
static zb_uint8_t zigbee_benchmark_ep_handler(zb_bufid_t bufid)
{
    ...
    NRF_LOG_DEBUG("New benchmark frame received, bufid: %u", bufid);
    ...
    else
    {
        ...
        zb_zcl_status = ZB_ZCL_STATUS_UNSUP_CMD;
        send_response = ZB_TRUE;
    }
