...
static void multi_sensor_clusters_attr_init(void)
{
    ...
    //m_dev_ctx.pres_attr.INFO          = ZB_ZCL_ATTR_PRES_INFO_VALUE;
      ...
      m_dev_ctx.pres_attr.INFO,
      SERIAL,
      ZB_ZCL_STRING_CONST_SIZE(SERIAL)
      );
...
void zigbee_info (){
    ...
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_CC_COEF_VALUE_ID, (zb_uint8_t *)&CC_COEF, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_SV_COEF_VALUE_ID, (zb_uint8_t *)&SV_COEF, ZB_FALSE);

    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_S_CAP_VALUE_ID, (zb_uint8_t *)&STARTING_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_S_VOLT_VALUE_ID, (zb_uint8_t *)&STARTING_VOLT, ZB_FALSE);

    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C1_VALUE_ID, (zb_uint8_t *)&MOD1_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C2_VALUE_ID, (zb_uint8_t *)&MOD2_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C3_VALUE_ID, (zb_uint8_t *)&MOD3_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C4_VALUE_ID, (zb_uint8_t *)&MOD4_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C5_VALUE_ID, (zb_uint8_t *)&MOD5_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C6_VALUE_ID, (zb_uint8_t *)&MOD6_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C7_VALUE_ID, (zb_uint8_t *)&MOD7_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_C8_VALUE_ID, (zb_uint8_t *)&MOD8_CAP, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V1_VALUE_ID, (zb_uint8_t *)&MOD1_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V2_VALUE_ID, (zb_uint8_t *)&MOD2_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V3_VALUE_ID, (zb_uint8_t *)&MOD3_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V4_VALUE_ID, (zb_uint8_t *)&MOD4_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V5_VALUE_ID, (zb_uint8_t *)&MOD5_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V6_VALUE_ID, (zb_uint8_t *)&MOD6_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V7_VALUE_ID, (zb_uint8_t *)&MOD7_VOLT, ZB_FALSE);
    //zb_zcl_set_attr_val(MULTI_SENSOR_ENDPOINT, ZB_ZCL_CLUSTER_ID_PRES3_MEASUREMENT, ZB_ZCL_CLUSTER_SERVER_ROLE, ZB_ZCL_ATTR_V8_VALUE_ID, (zb_uint8_t *)&MOD8_VOLT, ZB_FALSE);

    //not using the header file
    /* for now I am going to redefine these
    */
    //if (batt_data.set){//this should send some error to the hub saying that the data wasnt recieved and to reinitiate that.
    uint32_t STARTING_CAP = ave_cap();
    uint32_t STARTING_VOLT = ave_volt();
